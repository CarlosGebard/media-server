...
COMPOSE := docker compose --env-file $(COMPOSE_ENV) -f $(COMPOSE_BASE) -f $(COMPOSE_DEV)
COMPOSE_PROD_CONFIG := docker compose --env-file $(COMPOSE_ENV) -f $(COMPOSE_BASE) -f $(COMPOSE_PROD)
